...
export default ({navigation}) =>{
    ...
    const handleRegister = async () => {
        ...
        if(userInfo.email==""){
            ...
            const { data } = await Axios().register(formData)
        ...
        <Container>
            <LinearGradient colors={COLOR.linearGradientColor} style={S.linearGradient}>
                ...
                <View style={[S.Acenter, S.MB30, S.MT50]}>
                    ...
                    <Text style={[S.CLW, S.F25, S.FW700, S.MT10]}>Create Account</Text>
                    ...
                    <View style={[S.Aend, S.MT10]}>
                        <TouchableOpacity onPress={handleRegister}>
                            <LinearGradient
                                ...
                                style={S.authButton}>
                                <Text style={S.authButtonText}>SIGN UP</Text>
                                <Icon type="AntDesign" name="arrowright" style={S.rightIcon}/>
                            </LinearGradient>
                        </TouchableOpacity>
                    </View>
                    <View style={S.MT20}>
                        <Text style={S.orText}>Or Sign up with</Text>
                    </View>
                    ...
                    <View style={[S.MT15, S.ROW, S.Jcenter]}>
                        <Text style={S.orText}>Already have an account?   </Text>
                        <TouchableOpacity onPress={()=>navigation.push('LoginScreen')}>
                            <Text style={[S.orText, S.CText2, S.FW700]}>Sign in</Text>
                        </TouchableOpacity>
                    </View>
                </Content>
            </LinearGradient>
